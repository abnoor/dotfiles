...
function! CommentLine()
  ...
  if file_name =~ '\.cpp$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[23]\?$' || file_name =~ '\.opts$'
  ...
  elseif file_name =~ '\.tex$' 
    execute ":silent! normal ^i%\<ESC>==\<down>^"
  " for fortran files use C
  elseif file_name =~ '\.f$' 
    execute ":silent! normal ^iC\<ESC>==\<down>^"
...
function! UnCommentLine()
  ...
  " for fortran files use C
  elseif file_name =~ '\.f$' 
    execute ":silent! normal :nohlsearch\<CR>:s/\\C//\<CR>:nohlsearch\<CR>"
  " for all other files use # 
  else
    execute ":silent! normal :nohlsearch\<CR>:s/\\#//\<CR>:nohlsearch\<CR>"
  endif
...
function! RangeCommentLine()
  ...
  " for fortran files use C
  elseif file_name =~ '\.f$' 
    execute ":silent! normal :s/\\S/\\C\\0/\<CR>:nohlsearch<CR>"
  " for all other files use #  
  else
    execute ":silent! normal :s/\\S/\\#\\0/\<CR>:nohlsearch<CR>"
  endif
...
function! RangeUnCommentLine()
  ...
  " for fortran files use C
  elseif file_name =~ '\.f$' 
    execute ":silent! normal :s/\\\C//\<CR>:nohlsearch\<CR>"
  " for all other files use # 
  else
    execute ":silent! normal :s/\\#//\<CR>:nohlsearch\<CR>"
  endif
